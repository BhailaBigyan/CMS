...
$postsQuery = "SELECT id, title, description, image, category, author, created_at FROM blog_posts where (category ='Educational' OR category='Science and Technology') ORDER BY created_at DESC";
